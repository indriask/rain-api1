    ...
    <div class="dashboard__logout bg-white">
        <div id="logout-card-close-btn" class="d-flex">
            <button onclick="showLogoutCard()"
                class="dashboard__close-btn ms-auto click-animation bni-blue text-white border border-0">
        ...
        <div class="py-3 px-5">
            ...
            <button id="logout-card-btn" onclick="processLogoutRequest()"
                class="border border-0 bni-blue click-animation text-white d-block mx-auto fw-700 mt-4"
