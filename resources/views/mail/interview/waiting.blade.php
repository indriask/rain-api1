...
<head>
    ...
    <title>Wawancara mu sedang dalam antrian</title>
        ...
        <div class="mt-4">
            ...
            <div class="message-container mt-3 px-2">
                ...
                <p class="text-body-secondary my-0">
                    Kami ingin menginformasikan bahwa wawancara magang Anda di <strong>{{ $companyFullName }}</strong>
                    untuk posisi
                    <strong>{{ $vacancyTitle }}</strong> saat ini masih dalam antrian.
                    <br>
                    <br>
                    Kami akan memberi tahu Anda segera setelah ada pembaruan mengenai status lamaran Anda.
                </p>
                <p class="text-body-secondary my-2">Terima kasih atas kesabaran Anda.</p>
